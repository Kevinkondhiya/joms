...
<div id="main-content">
    <h1 id="title"> Pending Karigar Receive Todays Date </h1>
        <table cellpadding="7px">
            ...
            <tbody>
                <?php
                $todaydt = date('Y-m-d');
                    $select ="select *,DATE_FORMAT(krgdate, '%d-%m-%Y'),DATE_FORMAT(prodisdate, '%d-%m-%Y') from krissue where krdisdate <= STR_TO_DATE('$todaydt','%Y-%m-%d') and status = 'pending'";
