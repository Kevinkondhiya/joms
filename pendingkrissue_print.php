...
<body>
    ...
    <!-- <div id="maindiv"> -->
        <div id="main-content" class="main-content">
            ...
            <h2 style="text-align: center;"><b> Pending Krissue Report </b></h2>
            <?php
                $search2 = "select *,DATE_FORMAT(orderdt, '%d-%m-%Y'),DATE_FORMAT(disdate, '%d-%m-%Y') from orderpro where status = 'pending'";
